...
public class Carro {
    ...
    public Carro(String marca, String modelo, int anoFabrico, double potencia, int cilindrada, TipoCombustivel tipoCombustivel, double consumo) {
        this.marca = marca;
        this.modelo = modelo;
    ...
    public short ligar() {
        ...
        if (idadeAtual > 30) { // Mais de 30 anos
            ...
            if (this.potencia < 250) { // Menos de 250 cavalos
                ...
                //System.out.println("Vrum vrum, o carro está ligado!");
    ...
    public double calcularConsumo(double ditanciaKM) {
        double precoKM = (this.consumo * ditanciaKM) / 100;
        System.out.println("O consumo fica em " + precoKM + "L");
        return precoKM;
    }
